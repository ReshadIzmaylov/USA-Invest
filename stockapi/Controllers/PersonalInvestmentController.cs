...
namespace stockapi.Controllers
{
    ...
    public class PersonalInvestmentController : BaseController
    {
        ...
        private readonly IStockPortfolioService _stockService;

        public PersonalInvestmentController(ISubscriptionService subscriptionService, IStockPortfolioService stockService)
        {
